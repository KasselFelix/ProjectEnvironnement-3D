...
public class Example extends GLJPanel implements GLEventListener {
	...
	public void display(GLAutoDrawable drawable) {
		...
		gl.glRotatef(0, 0f, 0f, 90f);
		//affiche le model charger
	...
	public void init(GLAutoDrawable drawable) {
		...
		glu.gluPerspective(1, (double) getWidth() / getHeight(), 0.3, 100);
		gl.glMatrixMode(GL2.GL_MODELVIEW);
	}
	...
	private Boolean loadModels(GL2 gl) {
		chairModel = ModelLoaderOBJ.LoadModel("./models/Loup_gris.obj","./models/Loup_gris.mtl", gl);
		if (chairModel == null) {
			return false;
		}
		return true;
	...
	public void reshape(GLAutoDrawable drawable, int x, int y, int width,
		...
		glu.gluPerspective(100, (double) getWidth() / getHeight(), 0.1, 50);
		gl.glMatrixMode(GL2.GL_MODELVIEW);
